...
// 1. разместить название структур на картинке так чтоб они не вылазили за края канваса?
// 2. разместить название структур на картинке так чтоб они не перекрывали друг друга?
// 3. управлять размещением названий уже добавленных структур на канвасе?
// component CanvasInstance строка 106 добавление слушателя на отмеченную точку не работает
